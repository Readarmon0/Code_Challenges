...
namespace DotNetKoans.CSharp
{
    ...
    public class AboutMethods : Koan
    {
        ...
        {
            Assert.Equal(typeof(System.Int32), GiveMeBack<int>(1).GetType());
        ...
        public void MethodsCanBeOverloaded()
        {
            ...
            Assert.Equal(1, Overload(1));
            Assert.Equal(2, Overload("abc"));
            Assert.Equal(3, Overload(1, "abc"));
        }
        ...
        public void MethodCallsCanUseNamedParameters()
        {
            ...
            // the arguments.
            Assert.Equal(25, CalculateBMI(weight: 100, height: 2.0));
            Assert.Equal(25, CalculateBMI(height: 2.0, weight: 100));
        }
        ...
        public void MethodsCanHaveOptionalArguments()
        {
            ...
            Assert.Equal(9, MethodWithOptionalArguments(1,2,3));
            Assert.Equal(7, MethodWithOptionalArguments(1,2));
            Assert.Equal(6, MethodWithOptionalArguments(1));
            ...
            Assert.Equal(8, MethodWithOptionalArguments(1, c: 3));
        }
        ...
        public void MethodsCanHaveAVariableNumberOfParametersInAnArray()
        {
            ...
            string[] names = new string[3] { "Cory", "Will", "Corey" };
            Assert.Equal(names, LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
        }
        ...
        {
            string[] names = new string[3] { "Cory", "Will", "Corey" };
            Assert.Equal(names, this.MethodWithVariableArguments("Cory", "Will", "Corey"));
        }

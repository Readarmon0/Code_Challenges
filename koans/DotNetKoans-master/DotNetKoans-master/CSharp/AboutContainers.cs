...
namespace DotNetKoans.CSharp
{
	public class AboutContainers : Koan
	{
        ...
        [Koan(15)]
        public void RemovingItemsAtACertainPosition()
        {
            // The method RemoveAt removes the element at the given position
            List<int> list = new List<int> { 2, 1, 2, 3 };
            list.RemoveAt(2);
            int[] list2 = new int[3] { 2, 1, 3 };
            Assert.Equal(list2, list.ToArray());
        }
        ...
        public void OldStack()
        {
            ...
            stack.Push("last");
            Object[] list2 = new Object[3] { "last", 2, 1 };
            Assert.Equal(list2, stack.ToArray());
        }

...
(define-test test-integers-can-get-really-big
   ...
   (assert-true (typep 1234567890 'fixnum))
...
(define-test test-lisp-type-system-is-hierarchy
   ...
   (true-or-false? t (subtypep (type-of 2) (type-of 1))))
...
(define-test test-guess-that-type!
    (let ((x '(SIMPLE-ARRAY T (5 3 *))))
      ...
      (assert-true (not (subtypep  x '(SIMPLE-ARRAY ARRAY *))))

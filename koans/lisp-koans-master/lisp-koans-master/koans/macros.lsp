...
(defmacro log-form-with-value (form)
  ...
  `(let ((logform nil)
     ...
     (push '(:form ,form :value 1978) *log-with-value*)
...
(define-test test-log-form-and-value
  ...
  (assert-equal '(:form (log-form-with-value (- 2013 1978)) :value 1978) (first *log-with-value*))
  (assert-equal '(:form (- 2013 1978) :value 1978) (second *log-with-value*))
